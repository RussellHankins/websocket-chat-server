...
SRCS = websocket.cpp chatcommand.cpp chatcommand_addchatroom.cpp chatcommand_adduser.cpp chatcommand_getchatroomdetails.cpp chatcommand_getchatroomlist.cpp chatcommand_getusers.cpp chatcommand_getusersinchatroom.cpp chatcommand_joinchatroom.cpp chatcommand_leavechatroom.cpp chatcommand_login.cpp chatcommand_logout.cpp chatcommand_nop.cpp chatcommand_removechatroom.cpp chatcommand_removeuser.cpp chatcommand_send.cpp chatcommand_sendto.cpp chatcommand_sendtoall.cpp chatclient.cpp chatroom.cpp datablock.cpp datastring.cpp Debug.cpp error_signals.cpp message.cpp parameters.cpp sha256.cpp StackTrace.cpp stringbuilder.cpp task.cpp tasks.cpp test.cpp user.cpp
